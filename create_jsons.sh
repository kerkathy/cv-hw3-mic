...
python create_test_json.py --dataset ../hw3/data/hw3_dataset --subdir fog/train --output_json train_fog.json --output_id2name id2name_train_fog.json --subdir_as_path --dummy_bbox
